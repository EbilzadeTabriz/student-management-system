...
public class StudentController {
    ...
    //handler method to handle save student from submit
    ...
    //handler method to handle edit student from edit  submit request
   @PostMapping("/students/{studentId}")
    public String updateStudent(@PathVariable("studentId")Long studentId,
                              @Valid @ModelAttribute("students") StudentDto studentDto,
                                BindingResult result,
                                Model model){
        if (result.hasErrors()){
    ...
    //handler method to handle delete student records
    ...
    //handler method  to handle view student records;
